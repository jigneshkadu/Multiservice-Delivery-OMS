...
CREATE TABLE IF NOT EXISTS categories (
    ...
    theme_color VARCHAR(20) DEFAULT '#2874f0',
...
CREATE TABLE IF NOT EXISTS vendors (
    ...
    is_approved BOOLEAN DEFAULT TRUE, -- Set to TRUE for demo purposes
    image_url TEXT,
...
-- Seed some Vendors for testing
INSERT IGNORE INTO vendors (id, name, description, rating, lat, lng, address, contact, is_verified, is_approved, image_url, supports_delivery) VALUES
('v1', 'Dahanu Supermarket', 'Your one-stop shop for all groceries.', 4.5, 19.9900, 72.7300, 'Main Road, Dahanu', '9876543210', TRUE, TRUE, 'https://picsum.photos/seed/mart/400/300', TRUE),
('v2', 'Fresh Veggie Corner', 'Farm fresh vegetables delivered to your door.', 4.2, 19.9910, 72.7310, 'Market Area, Dahanu', '9876543211', TRUE, TRUE, 'https://picsum.photos/seed/fresh/400/300', TRUE),
('v3', 'Dahanu Medicals', '24/7 Pharmacy and medical supplies.', 4.8, 19.9920, 72.7320, 'Station Road, Dahanu', '9876543212', TRUE, TRUE, 'https://picsum.photos/seed/medical/400/300', FALSE);
...
CREATE TABLE IF NOT EXISTS riders (
    ...
    lat DECIMAL(10,8),
    lng DECIMAL(11,8),
    is_approved BOOLEAN DEFAULT TRUE, -- Set to TRUE for demo
    rating DECIMAL(3,1) DEFAULT 5.0,
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL
);

-- Seed some Riders
INSERT IGNORE INTO riders (id, name, phone, vehicle_type, status, lat, lng, is_approved) VALUES
('r1', 'Rahul Delivery', '9000000001', 'BIKE', 'ONLINE', 19.9905, 72.7305, TRUE),
('r2', 'Sameer Express', '9000000002', 'SCOOTER', 'ONLINE', 19.9915, 72.7315, TRUE);
